...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::group(['middleware'=>['Admin']],function(){
        ...
        Route::group(['middleware'=>['Warehouser']],function(){
            ...
            Route::put('/category/disable', [CategoryController::class], 'desactivar');
            Route::put('/category/enable', [CategoryController::class], 'activar');
            Route::get('/category/active', [CategoryController::class], 'activeCategories');

            //Articulos
            Route::get('/article', [ArticleController::class], 'index');
            Route::post('/article/new', [ArticleController::class], 'store');
            Route::put('/article/update', [ArticleController::class], 'update');
            Route::put('/article/disable', [ArticleController::class], 'changeStatus');
            Route::put('/article/enable', [ArticleController::class], 'changeStatus');
            Route::get('/article/searchArticle', [ArticleController::class], 'searchArticle');
            //Trae un Articulo disponible para la venta
            Route::get('/article/searchArticleStock', [ArticleController::class], 'searchArticleStock');
            // Todos los articulos disponibles para la venta getArticlesToSale
            Route::get('/article/getArticlesToSale', [ArticleController::class], 'getArticlesToSale');
            //Ruta par generar el pdf de articulos
            Route::get('/article/pdf', [ArticleController::class], 'listPDF')->name('articulos.pdf');
